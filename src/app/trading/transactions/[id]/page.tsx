...
import { TradingTransactionEditForm } from "./TradingTransactionEditForm";

export default async function TradingTransactionEditPage({
  params,
}: {
  ...
  return (
    <AppShell title="Edit transaction">
      <div className="space-y-4">
        ...
        <TradingTransactionEditForm transaction={transaction} />
      </div>
    </AppShell>
  );
}
